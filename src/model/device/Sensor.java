...
public abstract class Sensor extends Device {
    ...
    protected  ArrayList<LaserMeasurement> scanMeasurements;
    ...
    public Sensor(String name, MobileRobot robot, Position local, Environment environment){
    ...
    abstract double read(boolean first);
